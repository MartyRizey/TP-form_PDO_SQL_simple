...
function sqlInsertDatasReg($connectBdd, $pseudo, $birthday, $email, $pwdHash){
  ...
  // Je me connecte ($connectBdd) et applique la méthode PDO::prepare sur mon objet PDO de connection. Je passe en paramètre de prepare() la requête.
  // Ceci deviendra un objet de type PDOStatement.
