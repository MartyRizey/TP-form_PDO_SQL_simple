<?php
  ...
  // je récupére dans les paramètres de ma fonction les valeurs passées dans
  // l'appel de cette fonction dans le fichier Ctrl_InsertDatasReg.php
  // c'est à dire la connection à la Bdd ($connectBdd) et le pseudo ($pseudo)à
  // rechercher.
  function selectPseudo($connectBdd, $pseudo){

    // Je fais une requête de SELECTION en Bdd.
    // Je selectionne la colonne pseudo dans la table users_registred dont la
    // valeur et égal à $pseudo (càd le pseudo saisi par l'utilisateur).
